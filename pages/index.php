...
<body>
    <div class="wrapper mm-page mm-slideout" id="mm-0">
        ...
        <!-- Home Design -->
        <section class="home1-overlay home1_bgi1">
            <div class="container">
                <div class="row posr">
                    <div class="col-lg-12">
                        <div class="home_content">
                            <div class="home-text text-center">
                                ...
                                <p class="fz18 color-white">From as low as $10 per day with limited time offer
                                    discounts.
                                </p>
                            </div>
                                                    ...
                                                    <div class="small_dropdown2">
                                                        ...
                                                        <div class="dd_content2">
                                                            <div class="pricing_acontent">
                                                                ...
                                                                <span id="slider-range-value2">$98,000</span>
                                                                <div id="slider"
                                            ...
                                            <div class="thmb_cntnt">
                                                ...
                                                <ul class="icon mb0">
                                                    <li class="list-inline-item"><span
                                                            class="flaticon-transfer-1 text-white"></span>
                                                    </li>
                                                    <li class="list-inline-item"><span
                                                            class="flaticon-heart text-white"></span>
                                                    </li>
                                                </ul>
                                        ...
                                        <div class="details">
                                            <div class="tc_content">
                                                ...
                                                <ul class="prop_details mb0">
                                                    ...
                                                    <li class="list-inline-item"><span>Sq Ft: 5280</span>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="fp_footer">
                                                <ul class="fp_meta float-left mb0">
                                                    <li class="list-inline-item"><span href="#"><img
                                                                src="https://creativelayers.net/themes/findhouse-html/images/property/pposter1.png"
                                                                alt="pposter1.png"></span></li>
                                                    <li class="list-inline-item"><span href="#">Ali
                                                            Tufan</span>
                                                    </li>
                                                </ul>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-xl-4">
                        <div class="properti_city">
                            <div class="thumb"><img class="img-fluid w100"
                                    src="https://creativelayers.net/themes/findhouse-html/images/property/pc1.jpg"
                                    alt="pc1.jpg">
                            </div>
                            <div class="overlay">
                                <div class="details">
                    ...
                    <div class="col-lg-8 col-xl-8">
                        <div class="properti_city">
                            <div class="thumb"><img class="img-fluid w100"
                                    src="https://creativelayers.net/themes/findhouse-html/images/property/pc2.jpg"
                                    alt="pc2.jpg">
                            </div>
                            <div class="overlay">
                                <div class="details">
                    ...
                    <div class="col-lg-8 col-xl-8">
                        <div class="properti_city">
                            <div class="thumb"><img class="img-fluid w100"
                                    src="https://creativelayers.net/themes/findhouse-html/images/property/pc3.jpg"
                                    alt="pc3.jpg">
                            </div>
                            <div class="overlay">
                                <div class="details">
                    ...
                    <div class="col-lg-4 col-xl-4">
                        <div class="properti_city">
                            <div class="thumb"><img class="img-fluid w100"
                                    src="https://creativelayers.net/themes/findhouse-html/images/property/pc4.jpg"
                                    alt="pc4.jpg">
                            </div>
                            <div class="overlay">
                                <div class="details">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="why_chose_us">
                            ...
                            <div class="details">
                                ...
                                <p>Aliquam dictum elit vitae mauris facilisis at dictum urna dignissim donec vel lectus
                                    vel
                                    felis.</p>
                            </div>
                        </div>
        ...
        <section id="our-testimonials" class="our-testimonial">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-3">
                        <div class="testimonial_grid_slider owl-carousel owl-theme">
                            <div class="item">
                                <div class="testimonial_grid">
                                    <div class="thumb">
                                        <img src="https://creativelayers.net/themes/findhouse-html/images/testimonial/1.jpg"
                                            alt="1.jpg">
                                    </div>
                                    <div class="details">
                                        <h4>Augusta Silva</h4>
                                        <p>Sales Manager</p>
                                        <p class="mt25">Aliquam dictum elit vitae mauris facilisis at dictum
                                            urna dignissim donec vel lectus vel felis.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="for_blog feat_property">
                            <div class="thumb">
                                <img class="img-whp"
                                    src="https://creativelayers.net/themes/findhouse-html/images/blog/bh1.jpg"
                                    alt="bh1.jpg">
                            </div>
                            <div class="details">
                                <div class="tc_content">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="for_blog feat_property">
                            <div class="thumb">
                                <img class="img-whp"
                                    src="https://creativelayers.net/themes/findhouse-html/images/blog/bh2.jpg"
                                    alt="bh2.jpg">
                            </div>
                            <div class="details">
                                <div class="tc_content">
                    ...
                    <div class="col-md-6 col-lg-4 col-xl-4">
                        <div class="for_blog feat_property">
                            <div class="thumb">
                                <img class="img-whp"
                                    src="https://creativelayers.net/themes/findhouse-html/images/blog/bh3.jpg"
                                    alt="bh3.jpg">
                            </div>
                            <div class="details">
                                <div class="tc_content">
