                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="breadcrumb_content style2 mt30-767 mb30-767">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active text-thm" aria-current="page">Agent Single
                                        </li>
                                    </ol>
                            ...
                            <div class="col-lg-12">
                                <div class="feat_property list style2 agent">
                                    <div class="thumb">
                                        <img class="img-whp"
                                            src="https://creativelayers.net/themes/findhouse-html/images/team/11.jpg"
                                            alt="11.jpg">
                                                ...
                                                <div class="mbp_pagination_comments">
                                                    <div class="mbp_first media">
                                                        <div class="media-body">
                                                            <p class="mb25">Evans Tower very high demand corner junior
                                                                one
                                                            ...
                                                            <p class="mt10 mb0">Fully furnished. Elegantly appointed
                                                                condominium
                                                                unit situated on premier location. PS6. The wide entry
                                                                hall
                                                                leads to a large living room with dining area. This
                                                                expansive 2
                                                                bedroom and 2 renovated marble bathroom apartment has
                                                                great
                                                                windows. Despite the interior views, the apartments
                                                                Southern and
                                                                Eastern exposures allow for lovely natural light to fill
                                                                every
                                                                room. The master suite is surrounded by handcrafted
                                                                milkwork and
                                                ...
                                                <div class="feat_property list style2 hvr-bxshd bdrrn mb10 mt20">
                                                    ...
                                                    <div class="details">
                                                        <div class="tc_content">
                                                            ...
                                                            <p><span class="flaticon-placeholder"></span> 1421 San Pedro
                                                                St, Los
                                                                Angeles, CA 90015</p>
                                                            <ul class="prop_details mb0">
                                                                <li class="list-inline-item"><a href="#">Beds: 4</a>
                                                                </li>
                                                                <li class="list-inline-item"><a href="#">Baths: 2</a>
                                                                </li>
                                                                <li class="list-inline-item"><a href="#">Sq Ft: 5280</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="fp_footer">
                                                            <ul class="fp_meta float-left mb0">
                                                                ...
                                                                <li class="list-inline-item"><a href="#">Ali Tufan</a>
                                                                </li>
                                                            </ul>
                                                ...
                                                <div class="mbp_pagination_comments">
                                                    ...
                                                    <div class="mbp_first media">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <p class="mt10">Beautiful home, very picturesque and close
                                                                to
                                                                everything in jtree! A little warm for a hot weekend,
                                                                but would
                                                                love to come back during the cooler seasons!</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mbp_comment_form style2">
                                                        ...
                                                        <ul class="sspd_review">
                                                            ...
                                                            <li class="list-inline-item review_rating_para">Your Rating
                                                                &amp;
                                                                Review</li>
                                                        </ul>
                                                        <form class="comments_form">
                                                            ...
                                                            <button type="submit" class="btn btn-thm">Submit Review
