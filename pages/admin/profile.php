...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update_query = "UPDATE users SET username = ?, email = ?, first_name = ?, last_name = ?, position = ?, license = ?, tax_number = ?, phone = ?, fax_number = ?, mobile = ?, language = ?, company_name = ?, address = ?, about_me = ?, photo = COALESCE(?, photo) WHERE id = ?";
    $stmt = $conn->prepare($update_query);
    $stmt->execute([$username, $email, $first_name, $last_name, $position, $license, $tax_number, $phone, $fax_number, $mobile, $language, $company_name, $address, $about_me, $imagePath, $user_id]);
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div class="my_profile_setting_input form-group">
                                                            ...
                                                            <input type="number" class="form-control" name="mobile" value="<?= htmlspecialchars($user['mobile']); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div class="my_profile_setting_input form-group">
                                                    ...
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div class="my_profile_setting_input form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="formGroupExampleSkype" placeholder="alitfn">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-xl-6">
                                                        <div class="my_profile_setting_input form-group">
