...
// Count total
$count_sql = "SELECT COUNT(*) FROM property_type $search_sql";
...
// Fetch data
$data_sql = "SELECT * FROM property_type $search_sql ORDER BY id DESC LIMIT $start, $limit";
...
if (isset($_GET['delete_id'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM property_type WHERE id = ?");
...
<head>
    ...
    <title>Property Type List Page</title>
</head>
...
<body>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xl-4 mb10">
                                <div class="breadcrumb_content style2 mb30-991">
                                    <h2 class="breadcrumb_title">Property Type List</h2>
                                ...
                                <div class="candidate_revew_select style2 text-right mb30-991">
                                    <ul class="mb0 ">
                                        ...
                                        <li class="list-inline-item view_add_list" title="Add">
                                            <a href="../../pages/admin/property-type-add.php"><span class="flaticon-plus"></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <div class="table-responsive mt0">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><?= htmlspecialchars($property_type['name']) ?></td>
                                                            <td><?= date("d M, Y", strtotime($property_type['created_at'])) ?></td>
                                                            <td>
                                                                <ul class="view_edit_delete_list mb0">
                                                                    <li class="list-inline-item" title="Edit">
                                                                        <a href="property-type-edit.php?id=<?= $property_type['id'] ?>"><span class="flaticon-edit"></span></a>
                                                                    </li>
                                                                    <li class="list-inline-item" data-toggle="tooltip" title="Delete">
                                                                        <a href="property-type-list.php?delete_id=<?= $property_type['id']; ?>" onclick="return confirmDelete();">
    ...
    <script>
        function confirmDelete() {
            return confirm('Are you sure you want to delete this property type?');
        }
    </script>
