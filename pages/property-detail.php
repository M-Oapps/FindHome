                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="listing_single_description style2">
                                    ...
                                    <p class="mb25">Evans Tower very high demand corner junior one bedroom plus a large
                                        balcony
                                    ...
                                    <p class="gpara second_para white_goverlay mt10 mb10">Fully furnished. Elegantly
                                        appointed
                                        condominium unit situated on premier location. PS6. The wide entry hall leads to
                                        a large
                                        living room with dining area. This expansive 2 bedroom and 2 renovated marble
                                        bathroom
                                        apartment has great windows. Despite the interior views, the apartments Southern
                                        and
                                    ...
                                    <div class="collapse" id="collapseExample">
                                        <div class="card card-body">
                                            <p class="mt10 mb10">Fully furnished. Elegantly appointed condominium unit
                                                situated
                                                on premier location. PS6. The wide entry hall leads to a large living
                                                room with
                                                dining area. This expansive 2 bedroom and 2 renovated marble bathroom
                                                apartment
                                                has great windows. Despite the interior views, the apartments Southern
                                                and
                                                Eastern exposures allow for lovely natural light to fill every room. The
                                                master
                                ...
                                <div class="property_attachment_area">
                                    ...
                                    <div class="iba_container style2">
                                        <div class="icon_box_area style2">
                                            ...
                                            <div class="details">
                                                <h5><span class="flaticon-download text-thm pr10"></span> Demo Word
                                                    Document
                                                </h5>
                                            </div>
                                        </div>
                                        <div class="icon_box_area style2">
                                            ...
                                            <div class="details">
                                                <h5><span class="flaticon-download text-thm pr10"></span> Demo pdf
                                                    Document</h5>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4">
                                            <ul class="order_list list-inline-item">
                                                <li><a href="#"><span class="flaticon-tick"></span>Air Conditioning</a>
                                                </li>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4">
                                            <ul class="order_list list-inline-item">
                                                ...
                                                <li><a href="#"><span class="flaticon-tick"></span>Outdoor Shower</a>
                                                </li>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4">
                                            <ul class="order_list list-inline-item">
                                                <li><a href="#"><span class="flaticon-tick"></span>Swimming Pool</a>
                                                </li>
                                                ...
                                                <li><a href="#"><span class="flaticon-tick"></span>Window Coverings</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="col-lg-12">
                                <div class="application_statics mt30">
                                    <h4 class="mb30">Location <small class="float-right">1421 San Pedro St, Los Angeles,
                                            CA
                                            90015</small></h4>
                                        ...
                                        <div class="thumb">
                                            <div class="h400" id="map-canvas">
                                                <div className="gmap_canvas ">
                                                    <iframe
                                                        src="https://www.google.com/maps?q=28.6139,77.2090&amp;hl=en&amp;z=14&amp;output=embed"
                                            ...
                                            <div class="card floor_plan">
                                                ...
                                                <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                                    ...
                                                    <div class="card-body text-center">
                                                        <img class="img-fluid"
                                                            src="https://creativelayers.net/themes/findhouse-html/images/resource/floor_plan.png"
                                                            alt="floor_plan.png">
                                                        <p>Plan description. Lorem ipsum dolor sit amet, consectetuer
                                                            adipiscing
                            ...
                            <div class="col-lg-12">
                                <div class="shop_single_tab_content style2 mt30">
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link active" id="description-tab" data-toggle="tab"
                                                ...
                                                aria-selected="true">Property video</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" id="listing-tab" data-toggle="tab" href="#listing"
                                                role="tab" aria-controls="listing" aria-selected="false">Virtual
                                                Tour</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="myTabContent2">
                                            ...
                                            <div class="property_video">
                                                <div class="thumb">
                                                    <img class="pro_img img-fluid w100"
                                                        src="https://creativelayers.net/themes/findhouse-html/images/background/7.jpg"
                                                        alt="7.jpg">
                                                    <div class="overlay_icon">
                                                        <a class="video_popup_btn red popup-youtube"
                                        ...
                                        <div class="tab-pane fade row pl15 pl0-1199 pr15 pr0-1199" id="listing"
                                            ...
                                            <div class="property_video">
                                                <div class="thumb">
                                                    ...
                                                    <div class="overlay_icon">
                                                        <a class="video_popup_btn red popup-youtube"
                                                            href="https://www.youtube.com/watch?v=Jrs5yji5bb0"><span
                                                                class="flaticon-play"></span></a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="product_single_content">
                                    <div class="mbp_pagination_comments mt30">
                                        ...
                                        <div class="mbp_first media">
                                            <img src="https://creativelayers.net/themes/findhouse-html/images/testimonial/1.png"
                                                class="mr-3" alt="1.png">
                                            <div class="media-body">
                                                ...
                                                <p class="mt10">Beautiful home, very picturesque and close to everything
                                                    in
                                                    jtree! A little warm for a hot weekend, but would love to come back
                                                    during
                                                    the cooler seasons!</p>
                                            </div>
                                        </div>
                                        <div class="custom_hr"></div>
                                        <div class="mbp_first media">
                                            <img src="https://creativelayers.net/themes/findhouse-html/images/testimonial/2.png"
                                                class="mr-3" alt="2.png">
                                            <div class="media-body">
                                            ...
                                            <form class="comments_form">
                                                ...
                                                <div class="form-group">
                                                    <textarea class="form-control" id="exampleFormControlTextarea1"
                                                        rows="12" placeholder="Your Review"></textarea>
                                                </div>
                                        ...
                                        <div class="fp_footer">
                                            <ul class="fp_meta float-left mb0">
                                                <li class="list-inline-item"><a href="#"><img
                                                            src="https://creativelayers.net/themes/findhouse-html/images/property/pposter1.png"
                                                            alt="pposter1.png"></a>
                                                </li>
                        ...
                        <div class="sidebar_listing_list">
                            <div class="sidebar_advanced_search_widget">
                                <div class="sl_creator">
                                    ...
                                    <div class="media">
                                        <img class="mr-3"
                                            src="https://creativelayers.net/themes/findhouse-html/images/team/lc1.png"
                                            alt="lc1.png">
                                        <div class="media-body">
                                ...
                                <div class="item">
                                    <div class="feat_property home7 agent">
                                        <div class="thumb">
                                            ...
                                            <div class="thmb_cntnt">
                                                <ul class="tag mb0">
                                                    <li class="list-inline-item"><a href="#">For Rent</a>
                                                    </li>
                                                    <li class="list-inline-item"><a href="#">Featured</a>
                                                    </li>
                                                </ul>
                                                <a class="fp_price" href="#">$13,000<small>/mo</small></a>
                        ...
                        <div class="sidebar_feature_listing">
                            ...
                            <div class="media">
                                <img class="align-self-start mr-3"
                                    src="https://creativelayers.net/themes/findhouse-html/images/blog/fls1.jpg"
                                    alt="fls1.jpg">
                                <div class="media-body">
                            ...
                            <div class="media">
                                <img class="align-self-start mr-3"
                                    src="https://creativelayers.net/themes/findhouse-html/images/blog/fls2.jpg"
                                    alt="fls2.jpg">
                                <div class="media-body">
                            ...
                            <div class="media">
                                <img class="align-self-start mr-3"
                                    src="https://creativelayers.net/themes/findhouse-html/images/blog/fls3.jpg"
                                    alt="fls3.jpg">
                                <div class="media-body">
