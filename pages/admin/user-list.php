...
if (!empty($search)) {
    $search_sql = "WHERE username LIKE ? OR first_name LIKE ? OR last_name LIKE ? OR email LIKE ?";
...
<head>
    ...
    <title>User/Agent List Page</title>
</head>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-xl-4 mb10">
                                <div class="breadcrumb_content style2 mb30-991">
                                    <h2 class="breadcrumb_title">User/Agent List</h2>
                                ...
                                <div class="candidate_revew_select style2 text-right mb30-991">
                                    <ul class="mb0 ">
                                        ...
                                        <li class="list-inline-item view_add_list" title="Add">
                                            <a href="../../pages/admin/user-add.php"><span class="flaticon-plus"></span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                        ...
                                                        <tr>
                                                            <th scope="row">
                                                                <div class="feat_property list favorite_page style2">
                                                                    <div class="thumb">
                                                                        <img class="img-whp"
                                                                            src="<?= !empty($user['photo']) ? '../../' . $user['photo'] : '../../images/default-list.jpg'; ?>"
                                                                            alt="<?= htmlspecialchars($user['username']) ?>">
                                                                    </div>
                                                                    <div class="details">
                                                                        <div class="tc_content">
                                                                            <h4><?= htmlspecialchars($user['username']) ?></h4>
                                                                            <p></span><?= htmlspecialchars($user['email']) ?></p>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </th>
                                                            ...
                                                            <td>
                                                                <ul class="view_edit_delete_list mb0">
                                                                    <li class="list-inline-item" title="Edit">
                                                                        <a href="user-edit.php?id=<?= $user['id'] ?>"><span class="flaticon-edit"></span></a>
                                                                    </li>
                                                                    <li class="list-inline-item" data-toggle="tooltip" title="Delete">
                                                                        <a href="user-list.php?delete_id=<?= $user['id']; ?>" onclick="return confirmDelete();">
